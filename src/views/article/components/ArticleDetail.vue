  ...
  <div class="createPost-container">
    ...
    >
      ...
      <div class="createPost-main-container">
        ...
        <el-form-item prop="content_md" style="margin-bottom: 30px">
          <markdown-editor ref="markdownEditor" v-model="postForm.content_md" @content_generate="content_generate" />
        </el-form-item>
        <el-row>
          <el-col :span="24">
  ...
  methods: {
    ...
    getRemoteCategory(query) {
      listCategory(query).then((response) => {
        ...
        this.categoryListOptions = response.data.results.map((v) => v)
      })
    },
